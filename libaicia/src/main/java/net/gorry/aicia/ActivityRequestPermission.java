...
public class ActivityRequestPermission extends AppCompatActivity {
	...
	private String optServerName;
	private boolean optDonate;
	...
	public void onCreate(final Bundle savedInstanceState) {
		...
		if (i1 != null) {
			...
			if (extras != null) {
				optServerName = extras.getString("serverName");
				optDonate = extras.getBoolean("donate");
			}
		}
	...
	private void bootActivityMain() {
		...
		intent.putExtra("donate", optDonate);
		intent.putExtra("serverName", optServerName);
