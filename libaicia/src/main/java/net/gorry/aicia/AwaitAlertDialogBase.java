...
public abstract class AwaitAlertDialogBase {
	...
	AwaitAlertDialogBase(final Context context) {
		if (I) Log.i(TAG, "AlertListDialog()");
		me = context;
	}
	...
	private final void showDialogWaitDismiss(final Handler handler, final Dialog dialog, final OnDismissListener dismissListener ) {
		if (I) Log.i(TAG, "showDialogWaitDismiss()");
	...
	public void create() {
		...
		if (mCustomTitleView != null) {
			mDialog.setCustomTitle(mCustomTitleView);
		}
	}
	...
	public int show() {
		...
		showDialogWaitDismiss(mHandler, mDialog, new OnDismissListener() {
			public void onDismiss(final DialogInterface dialog) {
				if (I) Log.i(TAG, "open() dismiss");
			}
		});
		if (I) Log.i(TAG, "show() end");
	...
	public void setTitle(final String title) {
		if (I) Log.i(TAG, "setTitle()");
		mDialogTitle = title;
	}

	/**
	 * ダイアログのカスタムタイトルビューを設定
	 * @param view カスタムタイトルビュー
	 */
	public void setCustomTitleView(final View view) {
		if (I) Log.i(TAG, "setCustomTitleView()");
