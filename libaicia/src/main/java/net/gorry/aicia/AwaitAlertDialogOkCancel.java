...
/**
 * 
 * 入力待ち型アラートダイアログ（Ok/Cancel型）
 * 
 * @author GORRY
 *
 */
public class AwaitAlertDialogOkCancel extends AwaitAlertDialogBase {
	private static final String TAG = "AwaitAlertDialogOkCancel";
	 ...
	 */
	AwaitAlertDialogOkCancel(final Context context) {
		super(context);
	}
