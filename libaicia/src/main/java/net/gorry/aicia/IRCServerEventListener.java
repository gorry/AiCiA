...
public interface IRCServerEventListener extends EventListener {
	 ...
	 * @param dateMsg 日付時刻
	 * @param ssb Spanメッセージ
	 * @param forceSublog サブログへ出力を強制するときtrue
	 * @param forbidSublog サブログへ出力を禁止するときtrue
	 * @param alert アラートする必要があるときtrue
	 */
	public void receiveMessageToChannel(String serverName, String channel, String nick, String dateMsg, SpannableStringBuilder ssb, boolean forceSublog, boolean forbidSublog, boolean alert);
