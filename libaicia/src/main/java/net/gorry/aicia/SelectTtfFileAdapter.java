...
public class SelectTtfFileAdapter extends BaseAdapter {
	 ...
	 * @param pos pos
	 */
	public SelectTtfFileAdapter(final Context context, final File[] files, final int pos) {
		...
		typeTable.put("ttf", "application/x-truetype-font");
		...
		mTtfIcon = BitmapFactory.decodeResource(context.getResources(), R.drawable.icon_ttf);
	}
	...
	public View getView(final int position, final View convertView, final ViewGroup parent) {
		...
		if (convertView == null) {
			v = mInflater.inflate(R.layout.selectttffileadapter, null);
